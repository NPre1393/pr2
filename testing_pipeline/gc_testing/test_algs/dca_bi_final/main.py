...
def parse_params():
    ...
    parser.add_argument('--data', type = str,  default = '/content/drive/My Drive/pr2/dca_bi_final/data/syntheticA/filter_norm_expression0.mat')
    parser.add_argument('--graph_path', type = str, default = '/content/drive/My Drive/pr2/dca_bi_final/data/syntheticA/groundtruth.mat')
    parser.add_argument('--GTu_path', type = str,  default = '/content/drive/My Drive/pr2/dca_bi_final/data/syntheticA/groundtruth.mat')
    ...
    parser.add_argument('--save', type = str, default = '/content/drive/My Drive/pr2/dca_bi_final/data/save/model65.pt')
    parser.add_argument('--save_out', type = str, default = '/content/drive/My Drive/pr2/dca_bi_final/data/save/model65_gc_est.csv')
    parser.add_argument('--save_gt', type = str, default = '/content/drive/My Drive/pr2/dca_bi_final/data/save/model65_gc_gt.csv')
...
if __name__== '__main__':
    ...
    print(G_best)
    #args.save
    np.savetxt(args.save_out, G_best.reshape([NofGenes, NofGenes]), fmt='%d', delimiter=",")
    np.savetxt(args.save_gt, GroundTruth.reshape([NofGenes, NofGenes]), fmt='%d', delimiter=",")
