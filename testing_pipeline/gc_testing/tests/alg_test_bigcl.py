...
args = {'data':dataset1, 'result_path':'result1', 'model_path':'result2', 'algorithms':{'bigcl':args_bigcl}}
...
args = {'dataset':dataset2, 'result_path':'result1', 'model_path':'result2', 'algorithms':{'bigcl':0}}
